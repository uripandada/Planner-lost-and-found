...
namespace Planner.Application.MobileApi.Tasks.Commands.ReassignTaskForMobile
{
	public class ReassignTaskForMobileCommand: IRequest<ProcessResponseSimple<Guid>>
	{
	...
	public class ReassignTaskForMobileCommandHandler: IRequestHandler<ReassignTaskForMobileCommand, ProcessResponseSimple<Guid>>, IAmWebApplicationHandler
	{
		...
		public ReassignTaskForMobileCommandHandler(IDatabaseContext databaseContext, IHttpContextAccessor contextAccessor, ISystemTaskGenerator systemTaskGenerator, ISystemEventsService systemEventsService)
		{
		...
		public async Task<ProcessResponseSimple<Guid>> Handle(ReassignTaskForMobileCommand request, CancellationToken cancellationToken)
		{
			...
			using (var transaction = await this._databaseContext.Database.BeginTransactionAsync())
			{
				...
				newTask = new Domain.Entities.SystemTask
				{
					...
					IsForPlannedAttendant = request.IsForPlannedAttendant,
				};
