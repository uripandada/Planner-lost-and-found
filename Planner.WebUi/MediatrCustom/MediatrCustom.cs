...
//namespace Planner.WebUi.MediatrCustom
//{
//    using System;
//    using System.Collections.Generic;
//    using System.Linq;
...
//        /// <returns>Service collection</returns>
//        public static IServiceCollection AddMediatR(this IServiceCollection services, Action<MediatrCustomServiceConfiguration> configuration, params Assembly[] assemblies)
...
//        /// <param name="configuration">The action used to configure the options</param>
//        /// <returns>Service collection</returns>
//        public static IServiceCollection AddMediatR(this IServiceCollection services, IEnumerable<Assembly> assemblies, Action<MediatrCustomServiceConfiguration> configuration)
//        {
//            if (!assemblies.Any())
//            {
...
//            MediatrCustomServiceRegistrar.AddMediatRClasses(services, assemblies);
...
//        /// <param name="configuration">The action used to configure the options</param>
//        /// <returns>Service collection</returns>
//        public static IServiceCollection AddMediatR(this IServiceCollection services, Action<MediatrCustomServiceConfiguration> configuration, params Type[] handlerAssemblyMarkerTypes)
...
//        /// <param name="configuration">The action used to configure the options</param>
//        /// <returns>Service collection</returns>
//        public static IServiceCollection AddMediatR(this IServiceCollection services, IEnumerable<Type> handlerAssemblyMarkerTypes, Action<MediatrCustomServiceConfiguration> configuration)
...
//            ConnectImplementationsToTypesClosing(typeof(MediatR.IRequestHandler<,>), services, assembliesToScan, false);
