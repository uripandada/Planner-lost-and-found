...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20211026205909_AddedUserStatusAndHistory")]
    partial class AddedUserStatusAndHistory
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatus", b =>
                {
                    ...
                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_user_status_room_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatusHistory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_status_history");

                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_user_status_history_room_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_status_history_user_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatus", b =>
                {
                    b.HasOne("Planner.Domain.Entities.User", "User")
                        ...
                        .HasConstraintName("fk_user_status_asp_net_users_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Planner.Domain.Entities.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .HasConstraintName("fk_user_status_rooms_room_id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatusHistory", b =>
                {
                    b.HasOne("Planner.Domain.Entities.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .HasConstraintName("fk_user_status_history_rooms_room_id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Planner.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_user_status_history_asp_net_users_user_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
