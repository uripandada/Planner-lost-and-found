...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20201230152428_AddedTaskHistoryTables")]
    partial class AddedTaskHistoryTables
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.SystemTask", b =>
                {
                    ...
                    b.Property<string>("WhereReferenceId")
                        .IsRequired()
                        .HasColumnName("where_reference_id")
                        .HasColumnType("text");

                    b.Property<string>("WhereReferenceName")
                        .IsRequired()
                        .HasColumnName("where_reference_name")
                        .HasColumnType("text");

                    b.Property<string>("WhereTypeDescription")
                        .IsRequired()
                        .HasColumnName("where_type_description")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("WhoReferenceId")
                        .IsRequired()
                        .HasColumnName("who_reference_id")
                        .HasColumnType("text");

                    b.Property<string>("WhoReferenceName")
                        .IsRequired()
                        .HasColumnName("who_reference_name")
                        .HasColumnType("text");

                    b.Property<string>("WhoTypeDescription")
                        .IsRequired()
                        .HasColumnName("who_type_description")
                        .HasColumnType("text");

                    b.Property<string>("WhoTypeKey")
                        .IsRequired()
                        .HasColumnName("who_type_key")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.SystemTaskHistory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_system_task_history");

                    b.HasIndex("CreatedById")
                        .HasName("ix_system_task_history_created_by_id");

                    b.HasIndex("SystemTaskId")
                        .HasName("ix_system_task_history_system_task_id");

                    b.ToTable("system_task_history");
                });
            ...
            modelBuilder.Entity("Planner.Domain.Entities.SystemTaskHistory", b =>
                {
                    b.HasOne("Planner.Domain.Entities.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .HasConstraintName("fk_system_task_history_asp_net_users_created_by_id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Planner.Domain.Entities.SystemTask", "SystemTask")
                        .WithMany("History")
                        .HasForeignKey("SystemTaskId")
                        .HasConstraintName("fk_system_task_history_system_tasks_system_task_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
