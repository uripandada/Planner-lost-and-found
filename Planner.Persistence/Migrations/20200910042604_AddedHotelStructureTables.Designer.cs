...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20200910042604_AddedHotelStructureTables")]
    partial class AddedHotelStructureTables
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 3, 999, DateTimeKind.Unspecified).AddTicks(1971), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 0, DateTimeKind.Unspecified).AddTicks(845), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 2, DateTimeKind.Unspecified).AddTicks(2063), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 2, DateTimeKind.Unspecified).AddTicks(2425), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Floor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 2, DateTimeKind.Unspecified).AddTicks(8822), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 2, DateTimeKind.Unspecified).AddTicks(9117), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 6, DateTimeKind.Unspecified).AddTicks(5150), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 6, DateTimeKind.Unspecified).AddTicks(5472), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 7, DateTimeKind.Unspecified).AddTicks(2181), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 7, DateTimeKind.Unspecified).AddTicks(2490), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 7, DateTimeKind.Unspecified).AddTicks(9014), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 4, 26, 4, 7, DateTimeKind.Unspecified).AddTicks(9353), new TimeSpan(0, 0, 0, 0, 0)));
