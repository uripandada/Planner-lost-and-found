...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20200910080257_AddedHotelIdsToHotelStructureTables")]
    partial class AddedHotelIdsToHotelStructureTables
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 455, DateTimeKind.Unspecified).AddTicks(1031), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 456, DateTimeKind.Unspecified).AddTicks(121), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 458, DateTimeKind.Unspecified).AddTicks(1980), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 458, DateTimeKind.Unspecified).AddTicks(2347), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Floor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 458, DateTimeKind.Unspecified).AddTicks(9257), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 458, DateTimeKind.Unspecified).AddTicks(9563), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 462, DateTimeKind.Unspecified).AddTicks(6804), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 462, DateTimeKind.Unspecified).AddTicks(7128), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 463, DateTimeKind.Unspecified).AddTicks(4009), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 463, DateTimeKind.Unspecified).AddTicks(4326), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 464, DateTimeKind.Unspecified).AddTicks(1189), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 10, 8, 2, 57, 464, DateTimeKind.Unspecified).AddTicks(1937), new TimeSpan(0, 0, 0, 0, 0)));
