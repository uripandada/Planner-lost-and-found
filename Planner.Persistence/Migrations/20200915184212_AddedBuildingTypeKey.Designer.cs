...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20200915184212_AddedBuildingTypeKey")]
    partial class AddedBuildingTypeKey
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 855, DateTimeKind.Unspecified).AddTicks(5013), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 856, DateTimeKind.Unspecified).AddTicks(4316), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 858, DateTimeKind.Unspecified).AddTicks(5753), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 858, DateTimeKind.Unspecified).AddTicks(6127), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Floor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 859, DateTimeKind.Unspecified).AddTicks(3031), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 859, DateTimeKind.Unspecified).AddTicks(3350), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 863, DateTimeKind.Unspecified).AddTicks(538), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 863, DateTimeKind.Unspecified).AddTicks(959), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 863, DateTimeKind.Unspecified).AddTicks(7444), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 863, DateTimeKind.Unspecified).AddTicks(7802), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 864, DateTimeKind.Unspecified).AddTicks(5470), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 42, 11, 864, DateTimeKind.Unspecified).AddTicks(5906), new TimeSpan(0, 0, 0, 0, 0)));
