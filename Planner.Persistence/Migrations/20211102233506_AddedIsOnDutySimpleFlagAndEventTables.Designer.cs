...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20211102233506_AddedIsOnDutySimpleFlagAndEventTables")]
    partial class AddedIsOnDutySimpleFlagAndEventTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningHistoryEvent", b =>
                {
                    ...
                    b.Property<Guid>("CleaningPlanItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("cleaning_plan_item_id");
                    ...
                    b.HasIndex("CleaningPlanItemId")
                        .HasDatabaseName("ix_cleaning_history_events_cleaning_plan_item_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningInspection", b =>
                {
                    ...
                    b.HasIndex("CleaningPlanItemId")
                        .HasDatabaseName("ix_cleaning_inspections_cleaning_plan_item_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItem", b =>
                {
                    ...
                    b.HasIndex("InspectedById")
                        .HasDatabaseName("ix_cleaning_plan_items_inspected_by_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItemEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_cleaning_plan_item_events");

                    b.HasIndex("CleaningPlanItemId")
                        .HasDatabaseName("ix_cleaning_plan_item_events_cleaning_plan_item_id");

                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_cleaning_plan_item_events_created_by_id");

                    b.ToTable("cleaning_plan_item_events");
                });
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_user_statuses_room_id");

                    b.ToTable("user_statuses");
                });

            modelBuilder.Entity("Planner.Domain.Entities.UserStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_user_status_histories_room_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_status_histories_user_id");

                    b.ToTable("user_status_histories");
                });
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningHistoryEvent", b =>
                {
                    b.HasOne("Planner.Domain.Entities.CleaningPlanItem", "CleaningPlanItem")
                        .WithMany("CleaningHistoryEvents")
                        .HasForeignKey("CleaningPlanItemId")
                        .HasConstraintName("fk_cleaning_history_events_cleaning_plan_items_cleaning_plan_ite~")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningInspection", b =>
                {
                    b.HasOne("Planner.Domain.Entities.CleaningPlanItem", "CleaningPlanItem")
                        ...
                        .HasForeignKey("CleaningPlanItemId")
                        .HasConstraintName("fk_cleaning_inspections_cleaning_plan_items_cleaning_plan_item_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItem", b =>
                {
                    ...
                    b.HasOne("Planner.Domain.Entities.User", "InspectedBy")
                        ...
                        .HasConstraintName("fk_cleaning_plan_items_asp_net_users_inspected_by_id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItemEvent", b =>
                {
                    b.HasOne("Planner.Domain.Entities.CleaningPlanItem", "CleaningPlanItem")
                        .WithMany("History")
                        .HasForeignKey("CleaningPlanItemId")
                        .HasConstraintName("fk_cleaning_plan_item_events_cleaning_plan_items_cleaning_plan~")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Planner.Domain.Entities.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .HasConstraintName("fk_cleaning_plan_item_events_asp_net_users_created_by_id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatus", b =>
                {
                    b.HasOne("Planner.Domain.Entities.User", "User")
                        .WithOne("UserStatus")
                        .HasForeignKey("Planner.Domain.Entities.UserStatus", "Id")
                        .HasConstraintName("fk_user_statuses_asp_net_users_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Planner.Domain.Entities.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .HasConstraintName("fk_user_statuses_rooms_room_id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserStatusHistory", b =>
                {
                    b.HasOne("Planner.Domain.Entities.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .HasConstraintName("fk_user_status_histories_rooms_room_id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Planner.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_user_status_histories_asp_net_users_user_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
