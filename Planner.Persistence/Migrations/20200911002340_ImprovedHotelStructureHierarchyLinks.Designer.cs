...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20200911002340_ImprovedHotelStructureHierarchyLinks")]
    partial class ImprovedHotelStructureHierarchyLinks
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 461, DateTimeKind.Unspecified).AddTicks(1065), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 461, DateTimeKind.Unspecified).AddTicks(9814), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 464, DateTimeKind.Unspecified).AddTicks(2019), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 464, DateTimeKind.Unspecified).AddTicks(2431), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Floor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 464, DateTimeKind.Unspecified).AddTicks(9557), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 464, DateTimeKind.Unspecified).AddTicks(9915), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 469, DateTimeKind.Unspecified).AddTicks(4969), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 469, DateTimeKind.Unspecified).AddTicks(5438), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 470, DateTimeKind.Unspecified).AddTicks(3067), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 470, DateTimeKind.Unspecified).AddTicks(3465), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 471, DateTimeKind.Unspecified).AddTicks(8), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTime>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 11, 0, 23, 40, 471, DateTimeKind.Unspecified).AddTicks(332), new TimeSpan(0, 0, 0, 0, 0)));
