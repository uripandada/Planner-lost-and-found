...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20201001232208_UserSubGroupFK")]
    partial class UserSubGroupFK
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.HasIndex("UserGroupId1")
                        .HasName("ix_user_sub_groups_user_group_id1");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.HasOne("Planner.Domain.Entities.UserGroup", null)
                        .WithMany("UserSubGroups")
                        .HasForeignKey("UserGroupId1")
                        .HasConstraintName("fk_user_sub_groups_user_groups_user_group_id1")
                        .OnDelete(DeleteBehavior.Restrict);
                });
