...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20200915184417_AddedBuildingTypeKey2")]
    partial class AddedBuildingTypeKey2
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 55, DateTimeKind.Unspecified).AddTicks(3052), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 56, DateTimeKind.Unspecified).AddTicks(1706), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 58, DateTimeKind.Unspecified).AddTicks(3418), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 58, DateTimeKind.Unspecified).AddTicks(3795), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Floor", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 59, DateTimeKind.Unspecified).AddTicks(849), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 59, DateTimeKind.Unspecified).AddTicks(1206), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 62, DateTimeKind.Unspecified).AddTicks(7189), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 62, DateTimeKind.Unspecified).AddTicks(7514), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 63, DateTimeKind.Unspecified).AddTicks(4173), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 63, DateTimeKind.Unspecified).AddTicks(4478), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Planner.Domain.Entities.UserSubGroup", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasColumnName("created_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 64, DateTimeKind.Unspecified).AddTicks(1162), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedAt")
                        ...
                        .HasColumnName("modified_at")
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 9, 15, 18, 44, 17, 64, DateTimeKind.Unspecified).AddTicks(1774), new TimeSpan(0, 0, 0, 0, 0)));
