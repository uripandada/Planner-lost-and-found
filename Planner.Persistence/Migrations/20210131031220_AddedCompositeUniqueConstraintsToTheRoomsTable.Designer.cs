...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20210131031220_AddedCompositeUniqueConstraintsToTheRoomsTable")]
    partial class AddedCompositeUniqueConstraintsToTheRoomsTable
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<string>("OccupiedByReservationId")
                        .HasColumnName("occupied_by_reservation_id")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("OccupiedByReservationId")
                        .IsUnique()
                        .HasName("ix_rooms_occupied_by_reservation_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.HasOne("Planner.Domain.Entities.Reservation", "OccupiedByReservation")
                        .WithOne()
                        .HasForeignKey("Planner.Domain.Entities.Room", "OccupiedByReservationId")
                        .HasConstraintName("fk_rooms_reservations_occupied_by_reservation_id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
