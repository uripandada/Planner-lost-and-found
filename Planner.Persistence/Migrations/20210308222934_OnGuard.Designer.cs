...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20210308222934_OnGuard")]
    partial class OnGuard
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.LostAndFoundFiles", b =>
                {
                    ...
                    b.HasIndex("LostAndFoundId")
                        .HasName("ix_lost_and_found_files_lost_and_found_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.OnGuardFiles", b =>
                {
                    ...
                    b.HasIndex("OnGuardId")
                        .HasName("ix_on_guard_files_on_guard_id");
