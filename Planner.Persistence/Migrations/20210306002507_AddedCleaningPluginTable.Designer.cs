...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20210306002507_AddedCleaningPluginTable")]
    partial class AddedCleaningPluginTable
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlugin", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasName("ix_cleaning_plugins_created_by_id");

                    b.HasIndex("HotelId")
                        .HasName("ix_cleaning_plugins_hotel_id");

                    b.HasIndex("ModifiedById")
                        .HasName("ix_cleaning_plugins_modified_by_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlugin", b =>
                {
                    b.HasOne("Planner.Domain.Entities.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .HasConstraintName("fk_cleaning_plugins_asp_net_users_created_by_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Planner.Domain.Entities.User", "ModifiedBy")
                        .WithMany()
                        .HasForeignKey("ModifiedById")
                        .HasConstraintName("fk_cleaning_plugins_asp_net_users_modified_by_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
