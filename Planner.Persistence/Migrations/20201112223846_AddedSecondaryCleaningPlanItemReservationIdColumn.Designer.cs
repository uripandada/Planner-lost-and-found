...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20201112223846_AddedSecondaryCleaningPlanItemReservationIdColumn")]
    partial class AddedSecondaryCleaningPlanItemReservationIdColumn
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItem", b =>
                {
                    ...
                    b.HasIndex("CleanerId")
                        .HasName("ix_cleaning_plan_items_cleaner_id");

                    b.HasIndex("CleaningPlanId")
                        .HasName("ix_cleaning_plan_items_cleaning_plan_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlanItem", b =>
                {
                    b.HasOne("Planner.Domain.Entities.User", "Cleaner")
                        .WithMany()
                        .HasForeignKey("CleanerId")
                        .HasConstraintName("fk_cleaning_plan_items_asp_net_users_cleaner_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
