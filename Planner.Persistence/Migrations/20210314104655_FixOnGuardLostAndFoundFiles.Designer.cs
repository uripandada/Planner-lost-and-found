...
namespace Planner.Persistence.Migrations
{
    ...
    [Migration("20210314104655_FixOnGuardLostAndFoundFiles")]
    partial class FixOnGuardLostAndFoundFiles
    {
            ...
            modelBuilder.Entity("Planner.Domain.Entities.AssetAction", b =>
                {
                    ...
                    b.HasIndex("DefaultAssignedToUserGroupId")
                        .HasName("ix_asset_actions_default_assigned_to_user_group_id");

                    b.HasIndex("DefaultAssignedToUserId")
                        .HasName("ix_asset_actions_default_assigned_to_user_id");

                    b.HasIndex("DefaultAssignedToUserSubGroupId")
                        .HasName("ix_asset_actions_default_assigned_to_user_sub_group_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.CleaningPlugin", b =>
                {
                    ...
                    b.HasIndex("HotelId")
                        .HasName("ix_cleaning_plugins_hotel_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.LostAndFound", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasName("ix_lost_and_founds_created_by_id");

                    b.HasIndex("ModifiedById")
                        .HasName("ix_lost_and_founds_modified_by_id");

                    b.ToTable("lost_and_founds");
                });

            modelBuilder.Entity("Planner.Domain.Entities.LostAndFoundFiles", b =>
                {
                    ...
                    b.HasIndex("FileId")
                        .HasName("ix_lost_and_found_files_file_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.OnGuard", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasName("ix_on_guards_created_by_id");

                    b.HasIndex("ModifiedById")
                        .HasName("ix_on_guards_modified_by_id");

                    b.ToTable("on_guards");
                });

            modelBuilder.Entity("Planner.Domain.Entities.OnGuardFiles", b =>
                {
                    ...
                    b.HasIndex("FileId")
                        .HasName("ix_on_guard_files_file_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<ReservationOtherProperties>("OtherProperties")
                    ...
                    b.HasIndex("HotelId")
                        .HasName("ix_reservations_hotel_id");

                    b.HasIndex("RoomId")
                        .HasName("ix_reservations_room_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Room", b =>
                {
                    ...
                    b.HasIndex("HotelId", "ExternalId")
                        .IsUnique()
                        .HasName("ix_rooms_hotel_id_external_id");

                    b.HasIndex("HotelId", "Name")
                        .IsUnique()
                        .HasName("ix_rooms_hotel_id_name");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.RoomCategory", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasName("ix_room_categorys_created_by_id");

                    b.HasIndex("ModifiedById")
                        .HasName("ix_room_categorys_modified_by_id");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.SystemTaskMessage", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasName("ix_system_task_messages_created_by_id");

                    b.HasIndex("ModifiedById")
                        .HasName("ix_system_task_messages_modified_by_id");

                    b.HasIndex("SystemTaskId")
                        .HasName("ix_system_task_messages_system_task_id");
