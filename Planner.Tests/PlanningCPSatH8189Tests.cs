...
namespace Planner.Tests
{
    ...
    public class PlanningCPSATH8189Tests : PlanningCPSATTestsBase
    {

        public PlanningCPSATH8189Tests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        [Fact]
        public void TestJan19H8189NoVacantAssignment()
        {
        ...
        [Fact]
        public void TestJan19H8189AffinitiesNoVacantAssignment()
        {
            Strategy.CPSat.solverRunTime                          = 30;
            ...
            affinities = new List<String>(){"A-16", "A-23", "A-20"};
            var assigned_jobs_affinities2 = BasicCPSatTest(hotelId, hotelString, dataDateString, mystart, myend, attendantCount, roomDistances, acceptableTypes, affinities);
